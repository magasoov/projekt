...
const Menu = props => {
  ...
  const buildMenu = () => {
    if (winner === human) {
      ...
      return /*#__PURE__*/(
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' }, /*#__PURE__*/
        React.createElement("h1", { className: "title" }, "Проигрыш"), /*#__PURE__*/
        React.createElement("hr", null), /*#__PURE__*/
        React.createElement("div", null, /*#__PURE__*/
        React.createElement("p", { className: "menu-text" }, "by 01aushev"), /*#__PURE__*/
        React.createElement("button", { onClick: token => startGame('X') }, "X"), /*#__PURE__*/
        React.createElement("button", { onClick: token => startGame('O') }, "O"))));
      ...
      return /*#__PURE__*/(
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' }, /*#__PURE__*/
        React.createElement("h1", { className: "title" }, "Ничья!"), /*#__PURE__*/
        React.createElement("hr", null), /*#__PURE__*/
        React.createElement("div", null, /*#__PURE__*/
        React.createElement("p", { className: "menu-text" }, "by 01aushev"), /*#__PURE__*/
        React.createElement("button", { onClick: token => startGame('X') }, "X"), /*#__PURE__*/
      ...
      return /*#__PURE__*/(
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' }, /*#__PURE__*/
        React.createElement("h1", { className: "title" }, "Проиграешь))"), /*#__PURE__*/
        React.createElement("hr", null), /*#__PURE__*/
        React.createElement("div", null, /*#__PURE__*/
        React.createElement("button", { onClick: token => startGame('X') }, "X"), /*#__PURE__*/
        React.createElement("button", { onClick: token => startGame('O') }, "O"))));
